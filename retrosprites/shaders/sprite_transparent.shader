...
Shader "Error.mdl/Retro Sprites v2/Sprite Transparent"
{
    Properties
	{
    ...
    SubShader
    {
        Tags { "Queue"="Transparent" "RenderType"="Transparent" "DisableBatching"="True" "PreviewType" = "Plane"}
        ...
        Pass {
			...
			#include "cginc/sprite_frag.cginc"
            ENDCG
        }
    }
